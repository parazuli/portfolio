...
export default function App() {
  ...
  const projects = [
    ...
    },
    {
      id: "livora",
      title: "Livora",
      meta: "Healthcare logistics platform design",
      year: "2025",
      tag: "Self-directed practice",
      chip: "chip-outline",
      practice: true,
      blurb:
        "A healthcare logistics concept: sign-in, dashboard, and real-time monitoring screens designed around speed and trust for blood and organ delivery.",
      img: livoraWebappImg,
      alt: "The Livora healthcare logistics web app, showing the landing page and sign-in panel",
      logo: livoraLogo,
      logoAlt: "Livora logo",
    },
    {
      id: "nabil-bank",
      title: "Nabil Bank",
      meta: "Mobile banking app concept",
      year: "2025",
      tag: "Self-directed practice",
      chip: "chip-outline",
      practice: true,
      blurb:
        "A mobile banking concept: login, account overview, biometric verification, and scan-to-pay screens designed around a clean, card-based layout.",
      img: nabilBankImg,
      alt: "Mobile app design mockups for a Nabil Bank banking app concept, including login, home, and scan-to-pay screens",
      logo: nabilLogo,
